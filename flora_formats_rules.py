...
MASK_ONLY_ANSWER_META_INSTRUCTION_FIX_LIST = [ 
    """Only answer the instructions: {}.""",
    """Only respond to the instructions that are in the list {}.""",
    """Only consider answering the instructions listed in: {}.""",
    """Only address instructions that are specified in the collection: {}.""",
    """Include the instructions mentioned in {} from your response.""",
    """Focus solely on requests that are included in {}.""",
    """Consider the instructions contained within {}.""",
    """Respond exclusively to elements inside the specified list {}.""",
    """Focus on answering the instructions specified in {}.""",
]
...
ID_ANSWER_METHOD_INSTRUCTION_PAIR_DICT = {
    'ANSWER_TO_INSTRUCTION_ID': ID_ANSWER_INSTRUCTION,
}

ID_ANSWER_OVERALL_INSTRUCTION_LIST = [
    """{meta_instruction}\n{instruction_all}""",
    """{instruction_all}\n{meta_instruction}""",
    """{meta_instruction}\n\n{instruction_all}""",
    """{instruction_all}\n\n{meta_instruction}""",
...
################################################
# ANSWER NO ANSWER VERSION  QA_mask  #2
################################################
...
ANSWER_NO_ANSWER_SEQ_INTERVAL_LIST = [
    ' ',
    ',',
    ';',
    '-',
...
ANSWER_NO_ANSWER_METHOD_INSTRUCTION_PAIR_DICT = {
    'ANSWER_NO_ANSWER': ANSWER_NO_ANSWER,
}

ANSWER_NO_ANSWER_OVERALL_INSTRUCTION_LIST = [
    """{meta_instruction}\n{instruction_all}""",
    """{instruction_all}\n{meta_instruction}""",
    """{meta_instruction}\n\n{instruction_all}""",
    """{instruction_all}\n\n{meta_instruction}""",
...
QA_FEWSHOT_ANSWER = [
    """Please answer the following question based on other given question-answer examples.\n\n Here are some examples:\n\n {}.\n\n Based on these examples, please answer the following question:\n\n {}.\n\nAnswer: """,
...
QA_FEWSHOT_ANSWER_SEQ_TAG_LIST = [
    '{i}',
    '({i})', 
    '[{i}]', 
    '<{i}>',
...
QA_FEWSHOT_ANSWER_SEQ_INTERVAL_LIST = [
    ' ',
    ',',
    ';',
    '-',
...
QA_FEWSHOT_ANSWER_METHOD_INSTRUCTION_PAIR_DICT = {
    'QA_FEWSHOT_ANSWER': QA_FEWSHOT_ANSWER,
}

QA_FEWSHOT_ANSWER_OVERALL_INSTRUCTION_LIST = [
    """{meta_instruction}\n{instruction_all}""",
    """{instruction_all}\n{meta_instruction}""",
    """{meta_instruction}\n\n{instruction_all}""",
    """{instruction_all}\n\n{meta_instruction}""",
...
################################################
# NEXT_LINE_COMPLETE VERSION   #4
################################################

NEXT_LINE_COMPLETE = [
    """Please complete the next line of each pair of an instruction and an incomplete answer given below. Fill in each {} with the next line information. Answer with this template: Next line of the answer is: . """,
    """Please finish the following line of each pair of an instruction and an incomplete answer by adding the content to {}. Answer with this template: Next line of the answer is: .""",
    """Insert the necessary details into {} to fill in the next line of each instruction-answer pair. Answer with this template: Next line of the answer is: .""", 
    """Provide the next line of each instruction-answer pairs by filling in the details for {}. Answer with this template: Next line of the answer is: .""",
    """Please continue with the next line of the each instruction-answer pairs. Place the required information for each {}. Answer with this template: Next line of the answer is: .""",
    """Complete the subsequent line of each instruction-answer pairs by adding the details to {}. Answer with this template: Next line of the answer is: ."""
]

NEXT_LINE_COMPLETE_SEQ_TAG_LIST = [
    '{i}',
    '({i})', 
    '[{i}]', 
    '<{i}>',
...
NEXT_LINE_COMPLETE_SEQ_INTERVAL_LIST = [
    ' ',
    ',',
    ';',
    '-',
...
NEXT_LINE_COMPLETE_INSTRUCTION_PAIR_DICT = {
    'NEXT_LINE': NEXT_LINE_COMPLETE,
}

NEXT_LINE_COMPLETE_OVERALL_INSTRUCTION_LIST = [
    """{meta_instruction}\n{instruction_all}""",
    """{instruction_all}\n{meta_instruction}""",
    """{meta_instruction}\n\n{instruction_all}""",
    """{instruction_all}\n\n{meta_instruction}""",
...
ANSWER_BEFORE_AFTER_SEQ_TAG_LIST = [
    '{i}',
    '({i})', 
    '[{i}]', 
    '<{i}>',
...
ANSWER_BEFORE_AFTER_SEQ_INTERVAL_LIST = [
    ' ',
    ',',
    ';',
    '-',
...
ANSWER_BEFORE_AFTER_INSTRUCTION_PAIR_DICT = {
    'ANSWER_BEFORE': ANSWER_BEFORE,
    'ANSWER_AFTER':ANSWER_AFTER,
}

ANSWER_BEFORE_AFTER_OVERALL_INSTRUCTION_LIST = [
    """{meta_instruction}\n{instruction_all}""",
    """{instruction_all}\n{meta_instruction}""",
    """{meta_instruction}\n\n{instruction_all}""",
    """{instruction_all}\n\n{meta_instruction}""",
